...
export class CellPhoneComponent implements OnInit {
  ...
  cellPhoneType = new FormControl('', Validators.required);
  amount = new FormControl('', Validators.required);
  assetId = new FormControl('', Validators.required);
  assetStatus = new FormControl('', Validators.required);
  aggregatedGHG = new FormControl('', Validators.required);
  atCompany = new FormControl('', Validators.required);

  constructor(public serviceCellPhone: CellPhoneService, fb: FormBuilder) {
    this.myForm = fb.group({
      cellPhoneType: this.cellPhoneType,
      amount: this.amount,
      assetId: this.assetId,
      assetStatus: this.assetStatus,
      aggregatedGHG: this.aggregatedGHG,
      atCompany: this.atCompany
    });
  };
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceCellPhone.getAll()
    .toPromise()
    .then((result) => {
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      $class: 'org.supplychain.green.model.CellPhone',
      'cellPhoneType': this.cellPhoneType.value,
      'amount': this.amount.value,
      'assetId': this.assetId.value,
      'assetStatus': this.assetStatus.value,
      'aggregatedGHG': this.aggregatedGHG.value,
      'atCompany': this.atCompany.value
    };
    ...
    return this.serviceCellPhone.addAsset(this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateAsset(form: any): Promise<any> {
    ...
    return this.serviceCellPhone.updateAsset(form.get('assetId').value, this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  deleteAsset(): Promise<any> {
    ...
    return this.serviceCellPhone.deleteAsset(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceCellPhone.getAsset(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
      ...
      if (result.cellPhoneType) {
        formObject.cellPhoneType = result.cellPhoneType;
      } else {
        formObject.cellPhoneType = null;
      }
      ...
      if (result.atCompany) {
        formObject.atCompany = result.atCompany;
      } else {
        formObject.atCompany = null;
      }
