...
export class TransferComponent implements OnInit {
  ...
  toCompany = new FormControl('', Validators.required);
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: 'org.supplychain.green.model.Transfer',
      'assetToTransfer': this.assetToTransfer.value,
      'fromCompany': this.fromCompany.value,
      'toCompany': this.toCompany.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.fromCompany) {
        formObject.fromCompany = result.fromCompany;
      } else {
        formObject.fromCompany = null;
      }

      if (result.toCompany) {
        formObject.toCompany = result.toCompany;
      } else {
        formObject.toCompany = null;
      }
